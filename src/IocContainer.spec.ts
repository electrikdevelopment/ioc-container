...
describe('IocContainer', () => {
  ...
  it('creates an instance of a class with const constructor args', () => {
    const dao = container.registerConst('accountDaoConfig', { url: 'some-url' }).create(AccountDao, 'accountDaoConfig');
  ...
  it('creates an instance of a class with multiple class constructor args', () => {
    container.create(UserDao);
    container.registerConst('accountDaoConfig', { url: 'some-url' });
  ...
  it('can use register to create a class in a chain', () => {
    const httpService = container.register(UserDao).create(UserHttpService, UserDao);
    expect(httpService).toBeInstanceOf(UserHttpService);
    expect(httpService.dao).toBeInstanceOf(UserDao);
  });
